...
class BulkPostServiceInsertTestCase(unittest.TestCase):
    
    def setUp(self):
    	self.keywords = ".NET, ASP.NET, C#, Linq, JavaScript, Html5, Css3, jQuery, Python, REST, Developer, Animation, India, Android, Ios, Ipad, Iphone, Mobile".split(', ')
        ...
        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer nec odio. Praesent libero. Sed cursus ante dapibus diam. Sed nisi. Nulla quis sem at nibh elementum imperdiet.
         ...
         Morbi lacinia molestie dui. Praesent blandit dolor. Sed non quam. In vel mi sit amet augue congue elementum. Morbi in ipsum sit amet pede facilisis laoreet. Donec lacus nunc, viverra nec.</p>         
         <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer nec odio. Praesent libero. Sed cursus ante dapibus diam. Sed nisi. Nulla quis sem at nibh elementum imperdiet.
         Duis sagittis ipsum. Praesent mauris. Fusce nec tellus sed augue semper porta. 
         Mauris massa. Vestibulum lacinia arcu eget nulla. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Curabitur sodales ligula in libero.
         Sed dignissim lacinia nunc. Curabitur tortor. Pellentesque nibh. Aenean quam. In scelerisque sem at dolor. Maecenas mattis. Sed convallis tristique sem. Proin ut ligula vel nunc egestas porttitor. Morbi lectus risus, iaculis vel, suscipit quis, luctus non, massa.
    ...
    def test_bulk_insert(self):
        ...
        for i in range(1,50):
            ...
            s = random_index = randrange(0,l)
            e = random_index = randrange(0,l)
            e = -e if e < s else e
            post = self.service.create("Title" + str(i), 
                                    None,
                                    self.content,
                                    randomDate("1/1/2008 1:30 PM", "1/1/2012 4:50 AM", random()),
                                    None,
                                    self.keywords[s:e])
...
def strTimeProp(start, end, format, prop):
    ...
    structTime = time.localtime(ptime)
    return datetime(*structTime[:6])
